...
MODEL_LOCAL_PATH = os.path.join(_SCRIPT_DIR, "models", "BAAI", "bge-base-zh-v1.5")
FAISS_INDEX_PATH = os.path.join(_SCRIPT_DIR, "data", "event_faiss.index")
EVENT_MAPPING_PATH = os.path.join(_SCRIPT_DIR, "data", "event_mapping.csv")
EVENT_TABLE_PATH = os.path.join(_SCRIPT_DIR, "data", "event_table_llm.csv")
